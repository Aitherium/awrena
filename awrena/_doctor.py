...
interesting failures live BETWEEN them. "awrena is installed" is not the useful
fact -- "awrena is installed and the thing it pairs with is not" is. This reports
...
def _local_checks() -> "list[str]":
    ...
    from the registry, but it does not know what awrena needs at runtime, and a
